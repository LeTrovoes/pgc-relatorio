...
% testamos várias combinações de técnicas de aumentação de dados nas imagens
...
% LZT: talvez fassa mais sentido mover essa discussão para a seção de resultados e discussão
...
\begin{table}[h]
    ...
    023 & 0,9061 & 0,9746 & 0,9675 & 0,8506 & 0,8723 \\ % sens 95 deu 0.9080 offline
...
% LZT TODO inlcuir Subset Accuracy
...
% No conjunto de validação, o modelo atingiu uma distância de Hamming média de X, precisão Y, sensitividade (recall) Z e F1-score W, estas três últimas calculadas com média micro.
...
Entre as limitações do trabalho, destaca-se que o sistema foi avaliado apenas em um único conjunto de dados, sem validação externa em outras bases ou contextos clínicos. % de modo a avaliar a capacidade de generalização em outros conjuntos de dados, problema comum no uso de deep learnign em imagens de fundo de olho \cite{li_review_2021}.
